...
public class BookController extends BaseController {
	...
	public String loadBorrowRecordInfoPage(@RequestParam(value = "page", defaultValue = "1")Integer pageInteger ,ModelMap modelMap, HttpSession session) {
		...
		Pagination<BorrowRecord> pagination = bookService.getBorrowRecord(parameterPagination, user.getId());
